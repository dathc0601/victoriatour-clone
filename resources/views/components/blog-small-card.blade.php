...
<article class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 group">
    {{-- Image --}}
    ...
    <div class="p-4">
        ...
        {{-- Title --}}
        <h3 class="font-heading font-semibold text-gray-900 line-clamp-2 group-hover:text-primary-600 transition">
