...
<div class="differentiator-card group cursor-pointer" data-aos="fade-up">
    ...
    <div class="relative px-6 py-8 rounded-2xl transition-all duration-500 ease-out
        ...
        <div class="relative w-20 h-20 mx-auto mb-5">
            ...
            <div class="relative w-full h-full flex items-center justify-center
                ...
                @if($differentiator->icon)
                    @svg($differentiator->icon, 'w-10 h-10')
                @else
        ...
        <!-- Title -->
        <h3 class="text-gray-800 group-hover:text-primary-900 font-semibold text-base text-center
                   leading-snug transition-colors duration-300">
            {{ $differentiator->title }}
        </h3>

        <!-- Detail link - appears on hover -->
        <div class="mt-3 text-center overflow-hidden">
            <span class="inline-flex items-center gap-1 text-sm font-medium text-primary-800
